...
check_file_exists "templates/reality.conf.template"
check_file_exists "templates/reality_includes.conf.template"
check_file_exists "templates/xhttp.conf.template"
check_file_exists "templates/xhttp_includes.conf.template"
...
check_pattern_present "lib/nginx.sh" 'REALITY_LISTEN_DIRECTIVE' "nginx.sh renders reality HTTP/2 listen placeholder"
check_pattern_present "lib/nginx.sh" 'XHTTP_LISTEN_DIRECTIVE' "nginx.sh renders xhttp HTTP/2 listen placeholder"
check_pattern_present "templates/panel.conf.template" '{{PANEL_LISTEN_DIRECTIVE}}' "panel template uses HTTP/2 listen placeholder"
check_pattern_present "templates/reality.conf.template" '{{REALITY_LISTEN_DIRECTIVE}}' "reality template uses HTTP/2 listen placeholder"
check_pattern_present "templates/xhttp.conf.template" '{{XHTTP_LISTEN_DIRECTIVE}}' "xhttp template uses HTTP/2 listen placeholder"
...
check_pattern_present "templates/reality.conf.template" '{{HTTP2_DIRECTIVE}}' "reality template uses standalone HTTP/2 directive placeholder"
check_pattern_present "templates/xhttp.conf.template" '{{HTTP2_DIRECTIVE}}' "xhttp template uses standalone HTTP/2 directive placeholder"
